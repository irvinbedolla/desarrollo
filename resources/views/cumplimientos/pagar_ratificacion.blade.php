                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($pago->estatus == "Pagado")
                                                            @if($total == 1)
                                                                <a class="btn btn-success" href="{{ route('PDFcumplimientoR', $pago->id) }}" target="_blank">PDF</a>
                                                            @else
                                                                <a class="btn btn-success" href="{{ route('PDFpagos', $pago->id_solicitud) }}"  target="_blank">PDF</a>
                                                            @endif
