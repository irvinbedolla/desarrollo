                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6"><br>
                                        <div class="form-group">
                                            ...
                                            <select name="estatus" class="form-control">
                                                <option value="">Seleccione</option>
                                                <option value="Sin asignar"      @php if($folio->estatus === "Sin asignar") echo "selected"  @endphp>Sin asignar</option>
                                                <option value="Notificada"      @php if($folio->estatus === "Notificada") echo "selected"  @endphp>Notificada</option>
                                                <option value="No notificada"   @php if($folio->estatus === "No notificada") echo "selected"  @endphp>No notificada</option>
                                                <option value="Pendiente"      @php if($folio->estatus === "Pendiente") echo "selected"  @endphp>Pendiente</option>
                                                <option value="Exhorto"      @php if($folio->estatus === "Exhorto") echo "selected"  @endphp>Exhorto</option>
