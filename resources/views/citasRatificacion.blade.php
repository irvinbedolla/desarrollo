...
<head>
    ...
    <style>
        ...
        .loader {
            ...
            z-index: 9999;
            background: url("public/assets/images/pageLoader.gif") 50% 50% no-repeat rgba(255,255,255,0.85);
        }
    </style>
    @livewireStyles
</head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-institucional fixed-top px-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="public/assets/images/Logos 2.png" alt="CCL Michoacán" height="65">
            </a>
                            ...
                            <div id="datos_formulario" style="display:none;">
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="trabajador_curp" id="trabajador_curp" class="form-control text-uppercase" maxlength="18">
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="num_identificacion" maxlength="13" minlength="6" class="form-control text-uppercase" placeholder="De 6 a 13 caracteres" required>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="public/assets/images/capturaIne.png" alt="Identificación INE" class="img-fluid rounded border">
                </div>
            </div>
        </div>
    </div>
