...
<head>
    ...
    <style>
        ...
        .loader-overlay {
            ...
            height: 100%;
            z-index: 9999;
            background: rgba(255, 255, 255, 0.85) url('{{ asset("public/assets/images/pageLoader.gif") }}') 50% 50% no-repeat;
        }
    </style>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-institutional fixed-top py-2">
        <div class="container-fluid px-4">
            <a class="navbar-brand py-0" href="{{ route('publico') }}">
                <img src="{{ asset('public/assets/images/Logos 2.png') }}" alt="Logo CCL Michoacán" height="55">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link nav-link-custom d-flex align-items-center gap-1" href="{{ route('publico') }}">
