    ...
    <div class=" navbar-collapse">
        ...
        <ul class="navbar-nav ml-auto">
            <li >
                ...
                onclick="$('#modal-aviso-privacidad').modal('show')"><h6><b>Aviso de privacidad</b></h6></a>
            </li>
        </ul>
    </div>
</nav>
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Aceites y grasas vegetales1" data-nombre="Aceites y grasas vegetales" data-descripcion="
                                                                            <strong>Selecciona si la empresa del patrón:</strong> 
                                                                    ...
                                                                    <div class="col-11 row ">
                                                                        <label class="bold-gray-label pl-2" for="Aceites y grasas vegetales1">Aceites y grasas vegetales
                                                                            <a style="cursor: pointer;" class="popover_default ml-2" data-trigger="focus" data-placement="top" role="button" id="popover1" data-id="1" data-html="true" data-toggle="popover" title="" data-content="<div class=&quot;gray-small-text&quot;>
                                                                                ...
                                                                                <p>Se dedica a la producción de aceites y grasas vegetales comestibles, extraídos de las oleaginosas, principalmente de soya, canola y cártamo.</p> 
                                                                                <br>
                                                                                <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p></div>" data-original-title="Cerrar X"><i class="bi bi-info-circle-fill -Icon-16"></i></a>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="AUTOMOTRIZ3" data-nombre="Automotriz" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="3">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="AZUCARERA4" data-nombre="Azucarera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="4">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="CALERA6" data-nombre="Calera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="6">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Celulosa y papel7" data-nombre="Celulosa y papel" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="7">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="CEMENTERA8" data-nombre="Cementera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="8">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="CINEMATOGRÁFICA9" data-nombre="Cinematográfica" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="9">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="ELABORADORA DE BEBIDAS11" data-nombre="Elaboradora de bebidas" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="11">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="ELÉCTRICA12" data-nombre="Eléctrica" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="12">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Empresas administradas en forma directa o descentralizada del Gobierno Federal2" data-nombre="Empresas administradas en forma directa o descentralizada del gobierno federal" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="2">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Empresas que actúen en virtud de un contrato o concesión federal10" data-nombre="Empresas que actúen en virtud de un contrato o concesión federal" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="10">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Empresas que ejecuten trabajos en zonas federales o jurisdicción federal29" data-nombre="Empresas que ejecuten trabajos en zonas federales o jurisdicción federal" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="29">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="FERROCARRILERA13" data-nombre="Ferrocarrilera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="13">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="HIDROCARBUROS14" data-nombre="Hidrocarburos" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="14">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="HULERA15" data-nombre="Hulera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="15">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Maderera17" data-nombre="Maderera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="17">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Metalúrgica y siderúrgica18" data-nombre="Metalúrgica y siderúrgica" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="18">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="MINERA19" data-nombre="Minera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="19">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="PETROQUÍMICA20" data-nombre="Petroquímica" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="20">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="PRODUCTORA DE ALIMENTOS21" data-nombre="Productora de alimentos" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="21">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="QUÍMICA22" data-nombre="Química" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="22">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="Servicios de banca y crédito5" data-nombre="Servicios de banca y crédito" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="5">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="TABACALERA25" data-nombre="Tabacalera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="25">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  pl-md-3  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="TEXTIL26" data-nombre="Textil" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="26">
                                                                    </div>
                                                                    <div class="col-11 row ">
                                                                ...
                                                                <div class="col-md-6 content-vertical-center  border-r  row">
                                                                    <div class="col-1 mr-1">
                                                                        <input type="radio" class="radio_input industria" id="VIDRIERA27" data-nombre="Vidriera" data-descripcion="
                                                                            ...
                                                                            <br>
                                                                            <p>En caso contrario selecciona la opción &quot;Ninguna de las anteriores&quot;.</p>" name="industria" onclick="mostrarDetalleIndustria(this)" value="27">
                                                                    </div>
                                                                    <div class="col-11 row ">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12 gray-small-text ">
                    ...
                    <p>Acude a la Oficina Estatal del Centro Federal de Conciliación y Registro Laboral (CFCRL) de tu entidad para realizar la solicitud.</p>
                    <p>
...
<script>
    ...
    function validarIndustria() {
        ...
        if (industriasFederales.includes(nombreIndustria)) {
            ...
            window.location.href = "{{ route('solicitud_trabajador', ['tipo_solicitud' => $tipo_solicitud]) }}";
        }
    }
