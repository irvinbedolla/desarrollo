...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-institutional fixed-top py-2">
        <div class="container">
            <a class="navbar-brand py-0" href="#">
                <img src="public/assets/images/Logos 2.png" alt="Logo Centro de Conciliación Laboral" height="65">
            </a>
        </div>
    </nav>
    ...
    <main class="container my-4">
        ...
        <div class="banner-container mb-4">
            <img src="public/assets/images/Baner.png" class="img-fluid" alt="Banner Informativo Conciliación Laboral">
        </div>
