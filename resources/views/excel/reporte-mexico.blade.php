<table>
    <thead>
        <tr>
            <th style="background-color: #4CAF50; color: #ffffff; font-weight: bold; text-align: center;" colspan="12">
                RESUMEN DE SOLICITUDES Y RATIFICACIONES
            </th>
        </tr>
        <tr>
            <th style="background-color: #D3D3D3; font-weight: bold; width: 300px;">NUE</th>
            <th style="background-color: #D3D3D3; font-weight: bold; width: 150px;">Mes</th>
            <th style="background-color: #D3D3D3; font-weight: bold; width: 150px;">Año</th>
            ...
            <th style="background-color: #D3D3D3; font-weight: bold; width: 150px;">Actividad Economica</th>
            <th style="background-color: #D3D3D3; font-weight: bold; width: 150px;">Razón social</th>
