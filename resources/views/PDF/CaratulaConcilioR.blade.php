...
<body>
    ...
    <div class="contenido-principal">
        ...
        <table class="layout-table" style="margin-bottom: 20px;">
            <tr>
                <td width="45%" style="vertical-align: top;">
                    ...
                    <div class="pill" style="width: 80%; text-align: center;" >{{$ratificacion->consecutivo}}</div>
                </td>
                <td width="55%">
                    <table style="width: 100%; border-spacing: 0 8px;">
                        <tr>
                            <td>
                                ...
                                <div class="pill" style="height: 20px; text-align: center;">{{$conciliador}}</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="pill" style="height: 20px; text-align: center;">{{$ratificacion->año}}</div>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <div style="text-align: center; margin-bottom: 25px;">
            ...
            <div class="pill" style="width: 60%; margin: 0 auto; height: 20px;">{{$ratificacion->NUE}}</div>
        </div>

        <table class="layout-table">
            <tr>
                <td width="20%" class="label">SOLICITANTE:</td>
                <td width="80%"><div class="pill" style="height: 20px; text-align: center;">{{$ratificacion->trabajador}} {{$ratificacion->primero_trabajador}} {{$ratificacion->segundo_trabajador}}</div></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">OBJETO DE LA RATIFICACIÓN:</td>
        ...
        <table style="width: 100%; margin-top: 20px; border-collapse: collapse;">
            <tr>
                ...
                <td width="80%"><div class="pill" style="min-height: 30px; padding-top: 10px; padding-bottom: 10px;">{{ mb_strtoupper($ratificacion->observaciones, 'UTF-8') }}</div></td>
            </tr>
        </table>
                    ...
                    <td width="50%" style="vertical-align: top;">
                        <table style="width: 100%; border-spacing: 0 8px;">
                            ...
                            <tr>
                                ...
                                <td class="label-page2 "><center> SÍ <span class="pill-checkbox" style="margin-left: 10px; font-size: 15px;"> {{ $ratificacion->exepcion == 'Si' ? 'X' : '' }} </span> NO <span class="pill-checkbox" style="margin-left: 10px; font-size: 15px;"> {{ $ratificacion->exepcion == 'No' ? 'X' : '' }}</span></center></td><td></td> 
                            </tr>
                            <tr>
                                <td colspan="3">
                            ...
                            <tr>
                                <td width="30%" class="label-page2 "> MONTO: <span class="pill" style="margin-left: 10px; text-align:center;">${{number_format($monto, 2, '.', ',')}}</span></td>
                                <td class="label-page2" > NÚMERO DE PAGOS: <span class="pill" style="margin-left: 10px; text-align:center;">{{$pagos->count()}}</span></td>
                            </tr>
                            <tr>
                                <td width="20%">
