    ...
    <body>
        ...
        <main>
            <div class="content">
                ...
                <p>
                    En el <b>Centro de Conciliación Laboral del Estado de Michoacán de Ocampo con sede en {{ $solicitud->delegacion }}</b>, siendo las <b>{{ \Carbon\Carbon::parse($datosAudiencia->updated_at)->format('H:i') }} horas del
                    {{ \Carbon\Carbon::parse($datosAudiencia->updated_at)->translatedFormat('d \d\e F \d\e\l Y') }}</b>, hora y día señalados para la celebración de la Audiencia de Conciliación 
