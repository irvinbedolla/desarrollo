            ...
            <div class="content">
                ...
                <div class="razon-notificacion">
                    ...
                    <p>Siendo las <b>{{ $citado->updated_at->format('H') }} HORAS CON {{ $citado->updated_at->format('i') }} MINUTOS
                        ...
                        <b>{{strtoupper($citado->tipo_vialidad)}} {{$citado->calle}} {{$citado->n_ext}}@if($citado->n_int!=null) INT. {{$citado->n_int}}@endif, COLONIA {{$citado->colonia}}, {{strtoupper($municipioCitado, 'UTF-8')}}, CP {{$citado->cp}}, 
