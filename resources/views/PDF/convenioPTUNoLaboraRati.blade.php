        ...
        <main>
            <div class="content">
                ...
                <p><b>TERCERA</b>. Declara la parte <b>TRABAJADORA</b>:</p>
                    ...
                    <p class="sangria">                
                        b) Que por el desempeño de sus labores contaba con las siguientes prestaciones:<br>
                            ...
                            - Vacaciones: <b>{{ $ratificacion->vacaciones_dias}}</b> días al año.<br>
                            - Aguinaldo: <b>{{ $ratificacion->aguinaldo_dias }}</b> días al año.<br>
                            - Otras prestaciones (bonos, vales de despensa, seguros de gastos médicos mayores etc): <b>{{ $ratificacion->otros_dias }}</b>
                    </p>
                    <p class="sangria">
                        c) Que desempeñaba sus actividades laborales en las siguientes condiciones:<br>
                            - Horario: <b>{{ $ratificacion->horario}}</b><br>
                            - Horario de comida: <b>{{ $ratificacion->comida}}</b><br>
                            - Domicilio donde prestaba sus servicios: <b>{{ $ratificacion->tipo_vialidad }} {{ $ratificacion->calle }} {{ $ratificacion->num_ext }} @if(!empty($ratificacion->n_int))
                                   INT. {{ $ratificacion->n_int }}
                                @endif COLONIA {{ $ratificacion->colonia }}, {{ mb_strtoupper($municipioEmpresa, 'UTF-8') }}, {{ mb_strtoupper($estadoEmpresa, 'UTF-8') }} C.P. {{ $ratificacion->codigo_postal }}</b>.
                    </p>
                    <p class="sangria">
                    ...
                    <p class="sangria">
                        e) Que el día <b>{{ \Carbon\Carbon::parse($ratificacion->fecha)->translatedFormat('d \d\e F \d\e\l Y') }}</b> presentó solicitud para iniciar el procedimiento de conciliación prejudicial ante el Centro de Conciliación Laboral del 
                    ...
                    <p class="sangria">
                        f) Que el Centro Estatal, fijó la audiencia de conciliación para el día <b>{{ \Carbon\Carbon::parse($ratificacion->fecha)->translatedFormat('d \d\e F \d\e\l Y') }}.</b>
                    </p>
                ...
                <p> <b>CUARTA.</b> Declara la parte <b>EMPLEADORA:</b> </p>
                    ...
                    <p class="sangria">
                        c) Que con motivo del citatorio de fecha <b>{{ \Carbon\Carbon::parse($ratificacion->fecha)->translatedFormat('d \d\e F \d\e\l Y') }}</b> emitido por el Centro de Conciliación Laboral del Estado de Michoacán de Ocampo, la parte <b>EMPLEADORA</b> 
                    ...
                    <p>
                        ...
                        la Ley Federal del Trabajo, en fecha <b>{{ \Carbon\Carbon::parse($ratificacion->fecha_termino)->translatedFormat('d \d\e F \d\e\l Y') }};</b> asimismo han determinado que el presente convenio se celebra con la finalidad de dar por 
