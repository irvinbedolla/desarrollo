...
class Turnos extends Model {
    ...
    'NUE','observaciones','id_conciliador','municipio_rat','tipo_vialidad','calle','colonia','num_ext','num_int','codigo_postal','idAbogado','user_id','num_identificacion','estado_rat','año', 'id_historial','nacionalidad', 'incidencia', 'motivo_incidencia'];  
