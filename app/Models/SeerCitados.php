...
class SeerCitados extends Model
{
    ...
    'firma','problema_diligencia','genero','tez','edad_filiacion','altura','complexion','cabello','ojos','particulares','especificar','imagen_domicilio1','imagen_domicilio2','estado_citado'
    ];
