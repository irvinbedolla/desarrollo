...
*/
    ...
    Route::get('GeneraConstancia/{id}',                 [SeerController::class, 'genera_constancia'])->name('generaConstancia.form');
    ...
    //Constancias
    Route::post('GeneraConstancia/{id}',         [SeerController::class, 'genera_constancia'])->name('generaConstancia');
